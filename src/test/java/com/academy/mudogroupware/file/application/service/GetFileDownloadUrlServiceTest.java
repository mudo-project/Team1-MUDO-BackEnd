...
class GetFileDownloadUrlServiceTest {
    ...
    void batchResolvesDownloadUrlsForExistingFilesAndSkipsMissingOnes() {
        FileMetadataEntity fileA = FileMetadataEntity.restore(1L, "uploads/10/a.png", "image/png");
        FileMetadataEntity fileB = FileMetadataEntity.restore(2L, "uploads/10/b.png", "image/png");
        when(fileMetadataJpaRepository.findAllById(List.of(1L, 2L, 999L))).thenReturn(List.of(fileA, fileB));
