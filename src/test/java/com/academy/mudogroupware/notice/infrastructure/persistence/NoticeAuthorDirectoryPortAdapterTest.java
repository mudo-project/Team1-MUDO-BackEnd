...
class NoticeAuthorDirectoryPortAdapterTest {
    ...
    void getAuthorResolvesRoleNameViaRolePermissionLookupPort() {
        UserInfoEntity entity = entity(7L, "김지수", 5L);
    ...
    void getAuthorsLooksUpEachDistinctRoleIdOnlyOnce() {
        UserInfoEntity a = entity(1L, "이민준", 10L);
        UserInfoEntity b = entity(2L, "김지수", 10L);
        UserInfoEntity c = entity(3L, "박서준", 20L);
    ...
    private UserInfoEntity entity(Long id, String name, Long roleId) {
