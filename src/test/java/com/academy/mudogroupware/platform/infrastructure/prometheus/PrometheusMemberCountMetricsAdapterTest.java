...
class PrometheusMemberCountMetricsAdapterTest {

  @Test
  void activeMemberCountQueriesPrometheusWithoutUriEncodingFailure() throws IOException {
    HttpServer server = HttpServer.create(new InetSocketAddress(0), 0);
    server.createContext("/api/v1/query", exchange -> {
      byte[] bytes = "{\"status\":\"success\",\"data\":{\"result\":[{\"value\":[0,\"14\"]}]}}"
