...
public record UpdateTimetableSlotRequest(
    ...
    public UpdateTimetableSlotCommand toCommand(Long timetableSetId, Long timetableSlotId) {
        return new UpdateTimetableSlotCommand(timetableSetId, timetableSlotId, scope, classType, dayOfWeek,
                classroomCode, startTime, endTime, grade, teacherName, subjectName);
    }
}
