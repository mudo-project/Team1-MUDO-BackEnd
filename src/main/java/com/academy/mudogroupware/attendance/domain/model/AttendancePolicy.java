...
public final class AttendancePolicy {
    ...
    private AttendancePolicy(Long id, Long academyId,
        ...
        validate(academyId, defaultStartTime, defaultEndTime, lateGraceMinutes, weekdays);
        this.id = id;
    ...
    public static AttendancePolicy create(Long academyId,
        ...
        return new AttendancePolicy(null, academyId, defaultStartTime, defaultEndTime,
                lateGraceMinutes, weekdayExceptionEnabled, weekdays, now, now);
    }

    public static AttendancePolicy restore(Long id, Long academyId,
                                           LocalTime defaultStartTime,
                                           LocalTime defaultEndTime,
                                           int lateGraceMinutes,
                                           boolean weekdayExceptionEnabled,
        ...
        return new AttendancePolicy(id, academyId, defaultStartTime, defaultEndTime,
