...
public final class LeaveGrant {
    ...
    private LeaveGrant(Long id, Long academyId, Long userId, LocalDate grantDate, LocalDate expirationDate,
                       int grantedDays, LocalDateTime createdAt) {
        if (academyId == null || userId == null || grantDate == null || expirationDate == null
    ...
    public static LeaveGrant annual(Long academyId, Long userId, LocalDate grantDate, LocalDateTime createdAt) {
        return new LeaveGrant(null, academyId, userId, grantDate, grantDate.plusYears(1).minusDays(1),
                ANNUAL_GRANT_DAYS, createdAt);
    }

    public static LeaveGrant restore(Long id, Long academyId, Long userId, LocalDate grantDate,
                                     LocalDate expirationDate, int grantedDays, LocalDateTime createdAt) {
        return new LeaveGrant(id, academyId, userId, grantDate, expirationDate, grantedDays, createdAt);
    }
