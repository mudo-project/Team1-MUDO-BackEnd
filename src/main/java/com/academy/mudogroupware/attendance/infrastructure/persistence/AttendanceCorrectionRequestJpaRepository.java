...
public interface AttendanceCorrectionRequestJpaRepository extends JpaRepository<AttendanceCorrectionRequestJpaEntity, Long> {
    ...
    Slice<AttendanceCorrectionRequestJpaEntity> findPage(Pageable pageable);
    Slice<AttendanceCorrectionRequestJpaEntity> findAllByStatus(AttendanceCorrectionStatus status, Pageable pageable);
