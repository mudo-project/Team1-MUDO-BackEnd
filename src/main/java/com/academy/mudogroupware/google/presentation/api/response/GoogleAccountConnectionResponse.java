...
public record GoogleAccountConnectionResponse(String googleEmail, Long connectedByUserId, String connectedByUserName,
                                               String scope,
    ...
    public static GoogleAccountConnectionResponse from(GoogleAccountConnectionView view) {
        return new GoogleAccountConnectionResponse(view.googleEmail(), view.connectedByUserId(),
                view.connectedByUserName(), view.scope(),
