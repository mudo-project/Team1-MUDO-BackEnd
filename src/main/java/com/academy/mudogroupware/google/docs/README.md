...
| `GOOGLE_OAUTH_SCOPE` | 요청할 OAuth scope(공백 구분) | `openid email https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/documents https://www.googleapis.com/auth/spreadsheets`(계정 식별 + 드라이브/독스/시트 접근) |
