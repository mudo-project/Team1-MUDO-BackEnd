...
public record TaskCardResponse(
    ...
    public static TaskCardResponse from(TaskCardView view) {
        ...
        return new TaskCardResponse(view.id(), view.chatRoomId(), view.assignerId(), view.assignerName(),
                view.content(), view.dueDate(), assignees, view.completedCount(), view.assigneeCount(),
                view.fullyCompleted(), view.createdAt());
    }
}
