...
public interface PayrollAttendancePort {
  ...
  record AttendanceResult(
    ...
    public BigDecimal weeklyHolidayHours() { return hours(weeklyHolidayMinutes); }
  ...
  record DailyAttendance(LocalDate date, long regularWorkMinutes, long holidayMinutes) {}
}
