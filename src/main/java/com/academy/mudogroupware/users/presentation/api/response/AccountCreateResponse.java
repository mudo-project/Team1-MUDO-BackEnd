...
public record AccountCreateResponse(Long userId, String username, String temporaryPassword) {

    public static AccountCreateResponse from(CreateAccountResult result) {
        return new AccountCreateResponse(result.userId(), result.username(), result.temporaryPassword());
    }
}
